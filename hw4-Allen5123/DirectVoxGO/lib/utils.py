...
def load_model_inference(model_class, ckpt_path):
    ckpt = torch.load(ckpt_path, map_location='cpu')
    # print(f"model_state_dict : {ckpt['model_state_dict']} model_kwargs : {ckpt['model_kwargs']}")
    # print(ckpt['model_kwargs']['mask_cache_path'])
    ckpt['model_kwargs']['mask_cache_path'] = './hw4_1_c.tar'
