...
from lib.load_data import load_data_inference
...
def config_parser():
    ...
    parser.add_argument("--render_test", type=str, default='')
    ...
    parser.add_argument("--dump_images", type=str, default='')
...
def render_viewpoints(model, render_poses, HW, Ks, ndc, render_kwargs,
                      gt_imgs=None, savedir=None, dump_images='', fnames=None,
    ...
    if savedir is not None and dump_images:
        for i in trange(len(rgbs)):
            ...
            filename = os.path.join(savedir, f'{fnames[i]}.png')
...
def load_everything(args, cfg):
    ...
    '''
    data_dict = load_data_inference(cfg.data, args.render_test)

    # remove useless field
    kept_keys = {
            'hwf', 'HW', 'Ks', 'near', 'far', 'near_clip',
            'i_test', 'fnames', 'irregular_shape',
...
def train(args, cfg, data_dict):
    ...
    print(f'savepath : {coarse_ckpt_path}')
...
if __name__=='__main__':
    ...
    print(f"test json <--- {args.render_test} output ---> {args.dump_images}")
    # init enviroment
    ...
    if args.render_test or args.render_train or args.render_video:
        ...
        model = utils.load_model_inference(model_class, ckpt_path).to(device)
    ...
    if args.render_test:
        ...
        rgbs, depths, bgmaps = render_viewpoints(
                ...
                gt_imgs=None,
                savedir=testsavedir, dump_images=args.dump_images, fnames=data_dict['fnames'],
